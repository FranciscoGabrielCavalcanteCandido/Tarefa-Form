  ...
  Future<List<Map<String, Object?>>> _buscarDados() async {
    ...
    Database dataBase = await openDatabase(
      ...
      onCreate: (db, version) async {
        ...
        ''');
        db.execute(
            'INSERT INTO tarefa (nome, descricao) VALUES ("Projeto Integrador II", " teste 1")');
        db.execute(
            'INSERT INTO tarefa (nome, descricao) VALUES ("Construção de Software", " teste 2")');
        db.execute(
            'INSERT INTO tarefa (nome, descricao) VALUES ("Programação Web", " teste 3")');
        db.execute(
            'INSERT INTO tarefa (nome, descricao) VALUES ("Sistemas Operacionais", " teste 4")');
        db.execute(
            'INSERT INTO tarefa (nome, descricao) VALUES ("Desenvolvimento para Dispositivos Móveis", " teste 5")');
      },
    );
